...
import { ChevronRight, ChevronLeft, Clock, Activity } from 'lucide-react';
    ...
    >
      ...
      <div className="p-3 border-b border-mc-border">
        <div className="flex items-center">
          ...
          {!isMinimized && (
            <>
              <Activity className="w-3.5 h-3.5 text-ch-pulse mr-1.5" />
              <span className="text-sm font-medium uppercase tracking-wider">Activity Feed</span>
            </>
          )}
        </div>
