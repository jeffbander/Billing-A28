...
import { Heart, Settings, ChevronLeft, LayoutGrid, Activity } from 'lucide-react';
    ...
    <header className="h-14 bg-mc-bg-secondary border-b border-mc-border flex items-center justify-between px-4">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          <div className="relative">
            <Heart className="w-5 h-5 text-ch-cardio animate-heartbeat" fill="currentColor" />
          </div>
          ...
          <span className="text-[10px] text-mc-text-secondary px-1.5 py-0.5 bg-mc-bg-tertiary rounded">
            MC
          </span>
        </div>
      ...
      {workspace && (
        <div className="flex items-center gap-8">
          <div className="text-center">
            <div className="text-2xl font-bold text-ch-pulse">{activeAgents}</div>
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-mc-text-secondary uppercase">Missions</div>
          </div>
        </div>
      )}
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          />
          {isOnline ? 'ALBERT ONLINE' : 'ALBERT OFFLINE'}
        </div>
        <button
