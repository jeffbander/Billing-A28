      ...
      <div className="border-b border-mc-border bg-mc-bg-secondary">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-mc-text">ClawHealth Settings</h1>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <section className="mb-8 p-6 bg-mc-bg-secondary border border-mc-border rounded-lg">
          ...
          <p className="text-sm text-mc-text-secondary mb-4">
            Configure where ClawHealth Mission Control stores projects and deliverables.
          </p>
        ...
        <section className="mb-8 p-6 bg-mc-bg-secondary border border-mc-border rounded-lg">
          ...
          <p className="text-sm text-mc-text-secondary mb-4">
            Configure ClawHealth Mission Control API URL for agent orchestration.
          </p>
